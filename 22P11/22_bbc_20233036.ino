...
#define _DUTY_NEU  1528
#define _DUTY_MIN 960

#define _SERVO_ANGLE_DIFF  315  // Replace with |D - E| degree
#define _SERVO_SPEED       2000  // servo speed

#define _BANGBANG_RANGE    540  // duty up and down for bangbang control
...
void loop()
{
  ...
  if (event_dist) {
    ...
    if (dist_ema > _DIST_TARGET) {
      duty_target = _DUTY_NEU + _BANGBANG_RANGE - 100;
...
float volt_to_distance(int a_value)
{
  ...
  return 588+-2.43*a_value+4.5E-03*pow(a_value,2)-3.04E-06*pow(a_value,3);
}
